...
?>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" placeholder="Enter Post Tags..." name="tags"class="medium" />
                            </td>
                        </tr>
                     ...
                     <tr>
                            ...
                            <td>
                                <input type="text" placeholder="Enter Author Name..." name="author"value="<?php echo Session::get('username')?>"class="medium" />

                                <input type="hidden" placeholder="Enter Author Name..." name="userid"value="<?php echo Session::get('userId')?>"class="medium" />
                            </td>
                        </tr>
